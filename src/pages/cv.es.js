...
const cvPage = () => (
  <Layout>
    <SEO lang='es' url={`https://quiromaniaco.com/es/cv`} title='Curriculum Vitae | Manuel Quiroga' description='Este es mi curriculum' />
      <MobileContainer>
        <Fade in timeout={500}>
        ...
        <CurriculumData>
          <h3>Licenciado en Administracion de Empresas - <a href="https://ucc.edu.ar/" target="_blank">Universidad Catolica de Cordoba</a></h3>
          ...
          <h2>Idiomas</h2>
          <p className={'tags'}>#Espanol #Ingles #Aleman-A1</p>
